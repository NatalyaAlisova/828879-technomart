(function(){var btnPrev=document.querySelector('.slider-toggle-prev'),btnNext=document.querySelector('.slider-toggle-next');var images=Array.from(document.querySelectorAll('.slide'));var shownImage=document.querySelector('.shown');var shownPoint=document.querySelector('.slider-control-active');var pointsArray=document.querySelectorAll('.slider-control');var counter=images.indexOf(shownImage);btnPrev.addEventListener('click',function(){if(counter===0){images[counter].classList.remove('shown');pointsArray[counter].classList.remove('slider-control-active');counter=images.length-1}else{images[counter].classList.remove('shown');pointsArray[counter].classList.remove('slider-control-active');counter--}
